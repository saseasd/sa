...
exports.run = async (client, message, args) => {// kaanshu#1337
...
if(çekilecek === aktarılacak) return message.channel.send('Bir hata oluştu: Üyelerin çekileceği kanalın üyelerin olduğu kanal ile aynı olmaması gerekiyor.');
interval = 4000,// burayı ellemeyin.
increment = 1;
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['topluçek', 'toplucek', 'tc', 'tç'],
  permLevel: 0
};
